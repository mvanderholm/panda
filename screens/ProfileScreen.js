...
export default function ProfileScreen({ navigation }) {
    ...
    <ScrollView style={styles.tabContent} contentContainerStyle={isWide && styles.tabContentWide}>
      {editing ? (
        <View style={isWide ? styles.editGrid : null}>
          <View style={[styles.section, isWide && styles.sectionWide]}>
            ...
            {isWide ? (
              <View style={styles.inputRow}>
                <TextInput style={[styles.input, { flex: 1 }]} value={editFirst} onChangeText={setEditFirst} placeholder="First name" accessibilityLabel="First name" />
                <TextInput style={[styles.input, { flex: 1 }]} value={editLast} onChangeText={setEditLast} placeholder="Last name" accessibilityLabel="Last name" />
              </View>
            ) : (
              <>
          ...
          <View style={[{ flexDirection: 'row', gap: 10, margin: 16 }, isWide && { maxWidth: 500 }]}>
        ...
        <View style={isWide ? styles.viewGrid : null}>
          <View style={[styles.section, isWide && styles.sectionWide]}>
          ...
          <View style={isWide ? { maxWidth: 500, margin: 16 } : null}>
            <TouchableOpacity style={[styles.editBtn, isWide && { marginHorizontal: 0 }]} onPress={startEditing}>
  ...
  const renderContactTab = () => (
    <ScrollView style={styles.tabContent} contentContainerStyle={[{ padding: 16 }, isWide && { maxWidth: 700, alignSelf: 'center', width: '100%' }]}>
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={[styles.header, { paddingTop: insets.top + 16 }, isWide && styles.headerWide]}>
        <Text style={[styles.name, isWide && styles.nameWide]}>{member?.FIRST} {member?.LAST}</Text>
      </View>
      ...
      {activeTab === 'My Points'    && renderPointsTab()}
...
const styles = StyleSheet.create({
  ...
  tabContent: { flex: 1 },
  tabContentWide: { maxWidth: 1000, alignSelf: 'center', width: '100%', paddingTop: 8 },

  // Wide layout grids
  editGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 0 },
  viewGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 0 },
  sectionWide: { flex: 1, minWidth: 280, margin: 8 },
