...
export default function RewardDetailScreen({ route, navigation }) {
  ...
  const termsSection = reward.DISCLAIMER ? (
    <View style={styles.section}>
...
const styles = StyleSheet.create({
  ...
  contentWide: { maxWidth: 1000, alignSelf: 'center', width: '100%', paddingTop: 24 },
  ...
  expiry: { fontSize: 14, fontWeight: '700' },
  ...
  merchantLogo: { width: 60, height: 40, backgroundColor: '#f4f6f9', borderRadius: 6 },
  merchantName: { fontSize: 16, fontWeight: '600', color: '#1a1a1a' },
  division: { fontSize: 13, color: '#666', marginTop: 2 },
  disclaimer: { fontSize: 13, color: '#555', lineHeight: 20 },
